import "./feature.scss";
import image from "@/image/feature.webp";
            ...
            <div className="feature">
                <div className="info">
                    <h2 className="heading">
                        Features available with Mindmap Flow
                    </h2>
                    <div className="desc">
                ...
                <div className="teams">
                    ...
                    <div className="team">
                        <div className="sub-team">
                            <div className="icon">
                                <svg
                                    class="w-5 h-5 text-blue-500 lg:w-6 lg:h-6 dark:text-pink-500"
                                    fill="currentColor"
                                    viewBox="0 0 20 20"
                        ...
                        <div className="sub-team">
                            ...
                            <h3 className="heading">Business Automation</h3>
                            <div className="desc">
                        ...
                        <div className="sub-team">
                            ...
                            <h3 className="heading">Enterprise Design</h3>
                            <div className="desc">
                        ...
                        <div className="sub-team">
                            ...
                            <h3 className="heading">Operations</h3>
                            <div className="desc">
